...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Alternative Cost</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Alternative Cost</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <script>
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('report.alternative-cost-datatable') !!}",
                    type: 'POST',
                ...
                columns: [
                    ...
                    { data: 'nominal', name: 'nominal', searchable: false, orderable: true },
                    { data: 'pembuat', name: 'pembuat', searchable: true, orderable: false },
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('report.alternative-cost-datatable') !!}?"+params.toString()).load();
        }
