...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Daftar Outstanding Aktif</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Daftar Outstanding Aktif</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
...
@push('script')
    <script>
        ...
        $(document).on('click', '.btn-print', function(event) {
            ...
            $.ajax({
                url: "{{ route('report.generate-report-outstanding') }}",
                type: "post",
                data: params,
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('report.outstanding-datatable') !!}",
                    type: 'POST',
                    headers: {'X-CSRF-TOKEN': "{{ csrf_token() }}"}
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', searchable: false, orderable: false},
                    { data: 'nopen', name: 'nopen', searchable: true, orderable: true },
                    ...
                    { data: 'produk_pembiayaan', name: 'produk_pembiayaan', searchable: true, orderable: false },
                    ...
                    { data: 'angsuran', name: 'angsuran', searchable: false, orderable: true },
                    { data: 'angsuran_bank', name: 'angsuran_bank', searchable: false, orderable: true },
                    { data: 'pokok', name: 'pokok', searchable: false, orderable: false },
                    { data: 'angsuran_ke', name: 'angsuran_ke', searchable: false, orderable: false },
                    { data: 'sisa_tenor', name: 'sisa_tenor', searchable: false, orderable: false },
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('report.outstanding-datatable') !!}?"+params.toString()).load();
        }
