        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Fixed Cost</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <script>
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('report.fixed-cost-datatable') !!}",
                    type: 'POST',
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('report.fixed-cost-datatable') !!}?"+params.toString()).load();
        }
