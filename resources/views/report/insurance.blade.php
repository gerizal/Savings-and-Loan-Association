...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Daftar Pembayaran Asuransi</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Daftar Pembayaran Asuransi</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <script>
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('report.insurance-datatable') !!}",
                    type: 'POST',
                ...
                columns: [
                    ...
                    { data: 'asuransi', name: 'asuransi', searchable: false, orderable: true },
                    { data: 'status_pembayaran', name: 'status_pembayaran', searchable: false, orderable: true },
                    { data: 'tanggal_pembayaran', name: 'tanggal_pembayaran', searchable: false, orderable: true },
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('report.insurance-datatable') !!}?"+params.toString()).load();
        }
