...
@section('title','Cetak Penyerahan Jaminan')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Cetak Penyerahan Jaminan</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Cetak Penyerahan Jaminan</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <form id="formContract" action="{{route('files.print.guarantee')}}" method="post">
    ...
    <script>
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                filter: true,
                ajax: {
                    url: "{!! route('files.guarantee.datatable') !!}",
                    type: 'GET'
                },
                columns: [
                    {
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('files.guarantee.datatable') !!}?"+params.toString()).load();
        }
        ...
        $(document).on('click', '.btn-print-si', function(event) {
            ...
            var currentDate = $('.application-check:checked').length;
            var contractNumber = ``
            Swal.fire({
                title: "Cetak Penyerahan Jaminan",
                ...
                didOpen: function() {
                    ...
                    $('#datetimepicker').on('change.datetimepicker', function(e){
                        console.log(e);
                        contractNumber = `/JAMINAN/KPF/${moment(e.date).format("DDMMYYYY")}`;
        ...
        function printContract(values){
            ...
            $.ajax({
                url: "{{route('files.print.guarantee')}}",
                type: 'post',
                data: formData,
                processData: false,
                contentType: false,
