                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table>
                                ...
                                <tr><td>Lampiran &nbsp;&nbsp;</td><td>: 1 (satu) Daftar Nominatif</td></tr>
                                <tr><td>Perihal</td><td>: Penyerahan Berkas Pembiayaan {{$data['month']}} Tahun {{$data['year']}}</td></tr>
                            </table>
                            <p>
                            Kepada Yth<br/>
                            Direktur<br/>
                            ...
                            <table>
                                ...
                                <tr><td>3.&nbsp;</td><td>Dropping Ke Rek. {{env('APP_FULL_NAME')}}</td><td>: {{$data['submission_file']}}</td></tr>
                            </table>
                            <p>
                                ...
                                <tbody>
                                    @foreach($data['applications'] as $num => $application)
                                        <tr>
                                            ...
                                            <td class="text-right">{{$application['submission_file']}}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>{{$data['total_submission_file']}}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
