...
@section('title','Upload Surat Berkas')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Upload Surat Berkas</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Upload Surat Berkas</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
    ...
    <script>
        ...
        function getData(){
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('files.submission-files.datatable') !!}",
                    type: 'GET'
                },
                columns: [
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('files.submission-files.datatable') !!}?"+params.toString()).load();
        }
