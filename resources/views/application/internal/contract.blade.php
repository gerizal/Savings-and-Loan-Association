                                ...
                                <table class="tb-installment" style="margin-top:30px;width:110%;font-size:11px;margin-left:-45px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Jenis Produk</th>
                                            <th>Plafond</th>
                                            <th>Adm Bank & Provisi</th>
                                            <th>Pembukaan Rekening</th>
                                            <th>Dropping Koperasi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($data['applications'] as $num => $application)
                                            <tr>
                                                ...
                                                <td>{{$application['type']}}</td>
                                                <td class="text-right">{{$application['plafond']}}</td>
                                                <td class="text-right">{{$application['adm_provision_fee']}}</td>
                                                <td class="text-right">{{$application['account_opening_fee']}}</td>
                                                <td class="text-right">{{$application['dropping']}}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <th colspan="4" class="text-center">Total</th>
                                            <th>{{$data['total_plafond']}}</th>
                                            <th>{{$data['total_adm_provision_fee']}}</th>
                                            <th>{{$data['total_account_opening_fee']}}</th>
                                            <th>{{$data['total_dropping']}}</th>
                                        </tr>
                                    </tfoot>
                                </table>
