                        ...
                        <div class="tab-content col-md-12" id="myTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group required">
                                            ...
                                            {!! Form::textarea('address', null, ['class' => "form-control".($errors->has('address') ? ' is-invalid' : ''), 'id'=>'address','placeholder'=>'Alamat','rows'=>'3','readonly'=>true]) !!}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group required">
                                            ...
                                            {!! Form::text('geo_location', null, ['class' => "form-control".($errors->has('geo_location') ? ' is-invalid' : ''), 'id'=>'geo_location','placeholder'=>'Geo Location','readonly'=>true]) !!}
                                    ...
                                    <div class="col-md-12 d-none" id="domicileSection">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group required">
                                                    {!! Form::label('Alamat', null, ['class' => 'control-label']) !!}
                                                    {!! Form::textarea('domicile_address', null, ['class' => "form-control".($errors->has('domicile_address') ? ' is-invalid' : ''), 'id'=>'domicile_address','placeholder'=>'Alamat','rows'=>'3','readonly'=>true]) !!}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group required">
                                                    {!! Form::label('Geo Location', null, ['class' => 'control-label']) !!}
                                                    {!! Form::text('domicile_geo_location', null, ['class' => "form-control".($errors->has('domicile_geo_location') ? ' is-invalid' : ''), 'id'=>'domicile_geo_location','placeholder'=>'Geo Location','readonly'=>true]) !!}
                            ...
                            <div class="tab-pane fade" id="serviceUnit" role="tabpanel" aria-labelledby="serviceUnit">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row file-section-upload">
                                            <div class="col-md-12">
                                ...
                                @if($data->is_confirm)
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="divider-line"><span>Keterangan</span></div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group required">
                                                {!! Form::label('Keterangan', null, ['class' => 'control-label']) !!}
                                                {!! Form::textarea('description',null, ['class' => "form-control".($errors->has('description') ? ' is-invalid' : ''), 'id'=>'description','rows'=>'4']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-right {{ $data->is_confirm ? 'd-none':''}}">
                                            <button type="button" class="btn btn-warning d-none" id="btn-cancel"><i class="fas fa-times"></i> Batal</button>
                                            <button type="submit" class="btn btn-success d-none" id="btn-update" name="btn-update" value="update"><i class="fas fa-save"></i> Update</button>
                                            <a class="btn btn-warning" id="btn-edit" href="{{route('application.loan.edit', $data->id)}}"><i class="fas fa-edit"></i> Edit</a>
                                            <button type="submit" class="btn btn-success" id="btn-confirm" name="btn-confirm" value="confirm"><i class="fas fa-check"></i> Proses Slik</button>
                                        </div>

                                        <div class="text-right {{ $data->is_confirm ? '':'d-none'}}">
                                            <button type="submit" class="btn btn-danger" id="btn-reject" name="btn-reject" value="reject"><i class="fas fa-times"></i> Tolak</button>
                                            <button type="submit" class="btn btn-warning" id="btn-pending" name="btn-pending" value="pending"><i class="fas fa-clock"></i> Tunda</button>
                                            <button type="submit" class="btn btn-success" id="btn-approve" name="btn-approve" value="approve"><i class="fas fa-check"></i> Setuju</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(function () {
        ...
        $("#taspen_id").on("change", function(e){
            getTaspen(e.target.value, 'check')
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(data.domicile){
                    ...
                    $('#domicile_geo_location').val(data.domicile.geo_location)
    ...
    function readOnlyMode(readonly = true){
        ...
        var formAction = "{{$update_url}}"
        var formMethod = "PUT"

        if(readonly == true){
            $('.file-section-upload').addClass('d-none')
            formAction = "{{$confirm_url}}"
            formMethod = "POST"
        }else{
            $('.file-section-upload').removeClass('d-none')
        }
        $('#form-loan').attr('action', formAction).attr('method',formMethod);
