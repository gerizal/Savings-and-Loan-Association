...
@section('title','Pengajuan Slik')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tambah Pengajuan Slik</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('application.loan.index')}}">Pengajuan Slik</a></li>
                        ...
                        <div class="tab-content" id="myTabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            {!! Form::select('taspen_id',$taspens, null, ['class' => "form-control select2 ".($errors->has('taspen_id') ? ' is-invalid' : ''), 'id'=>'taspen_id','placeholder'=>'Nopen']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <div class="input-group date" id="birth_date" data-target-input="nearest">
                                                {!! Form::text('birth_date', null, ['class' => 'birth_date date-mask form-control datetimepicker-input'.($errors->has('birth_date') ? ' is-invalid' : ''),'placeholder'=>'Tanggal Lahir','data-target'=>'#birth_date']) !!}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group required">
                                            ...
                                            {!! Form::textarea('address', null, ['class' => "form-control map-input".($errors->has('address') ? ' is-invalid' : ''), 'id'=>'address','placeholder'=>'Alamat','rows'=>'3']) !!}
                                    ...
                                    <div class="col-md-12 d-none" id="domicileSection">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group required">
                                                    {!! Form::label('Alamat', null, ['class' => 'control-label']) !!}
                                                    {!! Form::textarea('domicile_address', null, ['class' => "form-control map-input".($errors->has('domicile_address') ? ' is-invalid' : ''), 'id'=>'domicile_address','placeholder'=>'Alamat','rows'=>'3']) !!}
                                    ...
                                    <div class="col-md-12 d-none" id="spouse">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group required @error('first_name') has-danger @enderror">
                                                    {!! Form::label('NIK ', null, ['class' => 'control-label']) !!}
                                                    {!! Form::text('spouse_id_number', null, ['class' => "form-control".($errors->has('spouse_id_number') ? ' is-invalid' : ''), 'id'=>'spouse_id_number','placeholder'=>'NIK']) !!}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group required">
                                                    ...
                                                    <div class="input-group date" id="spouse_birth_date" data-target-input="nearest">
                                                        {!! Form::text('spouse_birth_date', null, ['class' => 'date-mask form-control datetimepicker-input'.($errors->has('spouse_birth_date') ? ' is-invalid' : ''),'id'=>'sp_birth_date','placeholder'=>'Tanggal Lahir','data-target'=>'#spouse_birth_date']) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <div class="input-group date" id="skep_date" data-target-input="nearest">
                                                {!! Form::text('guarantee_skep_date', null, ['class' => 'date-mask form-control datetimepicker-input'.($errors->has('guarantee_skep_date') ? ' is-invalid' : ''),'id'=>'guarantee_skep_date','placeholder'=>'Tanggal Lahir','data-target'=>'#guarantee_skep_date']) !!}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            {!! Form::text('guarantee_skep_publisher', null, ['class' => "form-control".($errors->has('guarantee_skep_publisher') ? ' is-invalid' : ''), 'id'=>'guarantee_skep_publisher','placeholder'=>'Penerbit SK']) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('original_paymaster', null, ['class' => "form-control".($errors->has('original_paymaster') ? ' is-invalid' : ''), 'id'=>'original_paymaster','placeholder'=>'Juru Bayar Asal']) !!}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('destination_paymaster', null, ['class' => "form-control".($errors->has('destination_paymaster') ? ' is-invalid' : ''), 'id'=>'destination_paymaster','placeholder'=>'Juru Bayar Tujuan']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('previous_loan', null, ['class' => "form-control".($errors->has('previous_loan') ? ' is-invalid' : ''), 'id'=>'previous_loan','placeholder'=>'Pembiayaan Sebelumnya']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('bank_name', null, ['class' => "form-control".($errors->has('bank_name') ? ' is-invalid' : ''), 'id'=>'bank_name','placeholder'=>'Nama Bank']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('account_bank_number', null, ['class' => "form-control".($errors->has('account_bank_number') ? ' is-invalid' : ''), 'id'=>'account_bank_number','placeholder'=>'No Rekening','step'=>'1']) !!}
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group required">
                                                    ...
                                                    <div class="input-group date" id="datetime" data-target-input="nearest">
                                                        {!! Form::text('birth_date', null, ['class' => 'date-mask birth_date form-control datetimepicker-input'.($errors->has('birth_date') ? ' is-invalid' : ''), 'id'=>'birth_date','placeholder'=>'Tanggal Lahir','data-target'=>'#datetime','readonly'=>true]) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required">
                                                    ...
                                                    {!! Form::text('salary', null, ['class' => "currency-mask form-control".($errors->has('salary') ? ' is-invalid' : ''), 'id'=>'salary','placeholder'=>'Gaji Bersih']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required">
                                                    ...
                                                    {!! Form::select('product_id', $products, null, ['class' => "form-control".($errors->has('product_id') ? ' is-invalid' : ''), 'id'=>'product_id','placeholder'=>'Product Pembiayaan']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required">
                                                    ...
                                                    {!! Form::select('interest_type', ['flat'=>'Flat','anuitas'=>'Anuitas'], null, ['class' => "form-control".($errors->has('interest_type') ? ' is-invalid' : ''), 'id'=>'interest_type','placeholder'=>'Jenis Bunga']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required">
                                                    ...
                                                    {!! Form::select('referral_id', $referral, null, ['class' => "form-control".($errors->has('referral_id') ? ' is-invalid' : ''), 'id'=>'referral_id','placeholder'=>'Referral']) !!}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required">
                                                    ...
                                                    {!! Form::number('referral_fee', null, ['class' => "form-control".($errors->has('referral_fee') ? ' is-invalid' : ''), 'id'=>'referral_fee','placeholder'=>'Referral Fee', 'step'=>'0.01']) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::text('installment', null, ['class' => "currency-mask form-control".($errors->has('installment') ? ' is-invalid' : ''), 'id'=>'installment','placeholder'=>'installment', 'readonly'=>true, 'data-testid'=>'installment-field']) !!}
                                        ...
                                        <div class="card card-warning">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group required">
                                                            {!! Form::number('block_installment', null, ['class' => "text-right costs form-control".($errors->has('block_installment') ? ' is-invalid' : ''), 'id'=>'block_installment','placeholder'=>'0', 'readonly'=>true,'step'=>'1']) !!}
                                                    ...
                                                    {!! Form::hidden('total_cost', null, ['class' => "form-control", 'id'=>'total_cost']) !!}
                                                    {!! Form::hidden('primary_loan', null, ['class' => "form-control", 'id'=>'primary_loan']) !!}
                                                    {!! Form::hidden('margin', null, ['class' => "form-control", 'id'=>'margin']) !!}
                                                    {!! Form::hidden('bank_installment', null, ['class' => "form-control", 'id'=>'bank_installment']) !!}
                                                    {!! Form::hidden('col_fee', null, ['class' => "form-control", 'id'=>'col_fee']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="serviceUnit" role="tabpanel" aria-labelledby="serviceUnit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-right">
                                            <a href="{{route('application.loan.index')}}" class="btn btn-default"><i class="fas fa-times"></i> Batal</a>
...
<script>
    console.log('view', 'application.loan.form');
    var tempBank=null;
    ...
    $(function () {
        ...
        // Product dropdown menggunakan native select tanpa select2
        // $("#product_id").select2({
        //     theme: 'bootstrap4',
        //     tags: true,
        ...
        // $('#service_unit_id').attr('readonly',true).attr('disabled', true)
        // $('#branch_unit_id').attr('readonly',true).attr('disabled', true)
        // $('#marketing_id').attr('readonly',true).attr('disabled', true)
        // $('.birth_date').attr('disabled', true)
        // $('#sp_birth_date').attr('disabled', true)
        // $('#guarantee_skep_date').attr('disabled', true)
        // $('#product_id').attr('disabled', true)
        // $('#finance_type_id').attr('disabled', true)
        // $('#interest_type').attr('disabled', true)
        // $('#referral_id').attr('disabled', true)
        // if(errorsData.length > 0){
        //     getTaspen($("#taspen_id").val())
        //     $('#taspen_id').trigger('change')
        //     $('.birth_date').attr('disabled', false)
        //     $('#sp_birth_date').attr('disabled', false)
        //     $('#guarantee_skep_date').attr('disabled', false)
        //     $('#product_id').attr('disabled', false).trigger('change')
        //     $('#finance_type_id').attr('disabled', false).trigger('change')
        //     $('#interest_type').attr('disabled', false).trigger('change')
        //     $('#referral_id').attr('disabled', false).trigger('change')
        //     $('#service_unit_id').attr('readonly',false).attr('disabled', false).trigger('change')
        //     $('#branch_unit_id').attr('readonly',false).attr('disabled', false).trigger('change')
        //     $('#marketing_id').attr('readonly',false).attr('disabled', false).trigger('change')
        //     calculateResults()
        // }
        ...
        $("#account_bank_number").keyup(function () {
        ...
        $("#tenor").on('keyup', function(e){
            ...
            if(maxPlafon > tempProduct.max_plafon) {
                maxPlafon = tempProduct.max_plafon; // maxplafon can't more than product's max-plafon
            }
        ...
        $("#block_installment").on('change', function(e){
            var installment = $("#installment").val() || 0
            var blockirFee = parseInt(e.target.value) * parseInt(installment);
            $('#blockir_fee').val(blockirFee)
            calculateGrossAmount()
        ...
        $(".birth_date").on('keyup', function(e){
            if(e.target.value.length>=8){
                var today = moment();
                var birthDate = moment(e.target.value, 'DD-MM-YYYY');
        ...
        $(".costs").on('keyup', function(e){
            ...
            var primaryLoan=plafon/tenor
            var margin =installment-primaryLoan

            var interest = tempBank.interest/100
            var monthlyInterest = interest/12
            var bank_installment = pmt(monthlyInterest, tenor, plafon, tempBank.round_off)
            var col_fee =installment-bank_installment

            $('#gross_amount').val(gross_amount)
            $('#net_amount').val(net_amount)
            $('#total_cost').val(deduction)
            $('#primary_loan').val(primaryLoan)
            $('#margin').val(margin)
            $('#bank_installment').val(bank_installment)
            $('#col_fee').val(col_fee)
        });

        // Initialize Leaflet map for main address
        if (document.getElementById('address_map')) {
            const addressLat = parseFloat($('#address_latitude').val()) || -6.2088;
            const addressLng = parseFloat($('#address_longitude').val()) || 106.8456;
            initLeafletMap('address_map', addressLat, addressLng, 'address_latitude', 'address_longitude', 'address');
        }

        // Initialize domicile map only when the section is visible
        $('#is_domicile').on('change click', function() {
            const domicileSection = $('#domicileSection');
            if (!domicileSection.hasClass('d-none') && document.getElementById('domicile_address_map')) {
                // Delay initialization to ensure the container is visible
                setTimeout(function() {
                    const domicileLat = parseFloat($('#domicile_address_latitude').val()) || -6.2088;
                    const domicileLng = parseFloat($('#domicile_address_longitude').val()) || 106.8456;
                    if (!maps['domicile_address_map']) {
                        initLeafletMap('domicile_address_map', domicileLat, domicileLng, 'domicile_address_latitude', 'domicile_address_longitude', 'domicile_address');
                    }
                }, 100);
            }
        });

        // If domicile section is already visible on page load, initialize the map
        if (!$('#domicileSection').hasClass('d-none') && document.getElementById('domicile_address_map')) {
            setTimeout(function() {
                const domicileLat = parseFloat($('#domicile_address_latitude').val()) || -6.2088;
                const domicileLng = parseFloat($('#domicile_address_longitude').val()) || 106.8456;
        ...
        // Update map marker when location dropdowns change
        function updateMapFromLocation() {
            ...
            const subDistrict = $('#sub_district_id option:selected').text() || '';
            
            // Build full address string
            let fullAddress = '';
            if (subDistrict && subDistrict !== 'Please Select') fullAddress += subDistrict + ', ';
            if (district && district !== 'Please Select') fullAddress += district + ', ';
            if (city && city !== 'Please Select') fullAddress += city + ', ';
            if (province && province !== 'Please Select') fullAddress += province + ', ';
            fullAddress += 'Indonesia';
            
            // Only geocode if we have at least city
            if (city && city !== 'Please Select') {
                console.log('Geocoding address:', fullAddress);
                geocodeAddress(fullAddress, 'address_map', 'address_latitude', 'address_longitude');
            }
        }

        // Update domicile map when location dropdowns change
        function updateDomicileMapFromLocation() {
            const address = $('#domicile_address').val() || '';
            const province = $('#domicile_province_id option:selected').text() || '';
            const city = $('#domicile_city_id option:selected').text() || '';
            const district = $('#domicile_district_id option:selected').text() || '';
            const subDistrict = $('#domicile_sub_district_id option:selected').text() || '';
            ...
            // Only geocode if we have at least city
            if (city && city !== 'Please Select') {
                console.log('Geocoding domicile address:', fullAddress);
                geocodeAddress(fullAddress, 'domicile_address_map', 'domicile_address_latitude', 'domicile_address_longitude');
            }
        }

        // Attach event listeners to location dropdowns
        $('#province_id, #city_id, #district_id, #sub_district_id').on('change', function() {
            setTimeout(updateMapFromLocation, 500);
        });

        // Attach event listeners to domicile location dropdowns
        $('#domicile_province_id, #domicile_city_id, #domicile_district_id, #domicile_sub_district_id').on('change', function() {
            setTimeout(updateDomicileMapFromLocation, 500);
        });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(data, function(key, value) {
                    $('#product_id').append($('<option>').text(value.name).attr('value', value.id).attr('maxtenor', value.max_tenor).attr('maxplafon', value.max_plafon).attr('data',JSON.stringify(value)).attr('title',value.bank.name));
                });
    ...
    function getType(){
        $.ajax({
            ...
            success: function (response) {
                var data = response
                var defaultValue = "{{$data->finance_type_id}}"
                $('#finance_type_id').empty();
                $.each(data, function(key, value) {
                    if(defaultValue){
                        $('#finance_type_id').append($('<option>').text(value.name).attr('value', value.id).attr('selected',true).attr('data',JSON.stringify(value)));
                    }else{
    ...
    function countInsurance(plafon){
        if(tempProduct){
            var result = parseInt((tempProduct.insurance_fee/100)*plafon)
            $('#insurance_fee').val(result);
        }
    }
    function countProvision(plafon){
        if(tempBank){
            var result = (tempBank.provision_fee > 100 ? parseInt(tempBank.provision_fee) : parseInt(tempBank.provision_fee/100)*plafon)
    ...
    function getTaspen(id, type='check'){
        // $('#profileTab .form-control').attr({
        //     'readonly':false
        // })
        // $('#guaranteeTab .form-control').attr({
        //     'readonly':false
        // })
        $.ajax({
            ...
            success: function (response) {
                if(response.status=='error'){
                    ...
                    if(data){
                        ...
                        $('#skep_name').val(null)
                        $('#nopen').val(id)
                        $('#skep_number').val(null)
                        $('#employee_code').val(null)
                        $('#employee_grade').val(null)
                        $('#retirement_type').val(null)
                        $('#name').val(null)
                        $('#id_number').val(null)
                        ...
                        $('#rw').val(null)
                        $('#post_code').val(null)
                        $('#is_domicile').val(null)
                        $('#current_job').val(null)
                        $('#current_job_address').val(null)
                        $('#business_type').val(null)
                        $('#marital_status').val(null)
                        $('#guarantee_skep_publisher').val(null)
                        $('#guarantee_skep_number').val(null)
                        $('#guarantee_skep_date').val(null)
                        $('#guarantee_employee_grade').val(null)
                        $('#salary').attr('readonly', false)
                        $('#original_paymaster').attr('readonly', false)
                        $('#destination_paymaster').attr('readonly', false)
                        $('#previous_loan').attr('readonly', false)
                        ...
                        $('#domicile_address').val(null)
                        $('#domicile_province_id').val(null)
                        $('#domicile_city_id').val(null)
                        $('#domicile_district_id').val(null)
                        $('#domicile_sub_district_id').val(null)
                        $('#domicile_rt').val(null)
                        $('#domicile_rw').val(null)
                        $('#domicile_post_code').val(null)
                        $('#residential_status').val(null)
                        $('#occupied_at').val(null)
                        // getCity(data.province_id,'#domicile_city_id', data.domicile.city_id)
                        // getDistrict(data.city_id, "#domicile_district_id", data.domicile.district_id)
                        // getSubDistrict(data.district_id, "#domicile_sub_district_id", data.domicile.sub_district_id)

                        $('#spouse_name').val(null)
                        $('#spouse_id_number').val(null)
                        $('#sp_birth_date').val(null)
                        $('#spouse_birth_place').val(null)
                        $('#spouse_job').val(null)
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                response.forEach(val => {
                    ...
                    $('#job_position').val(val.job_title)
                    $('#pkwt_status').val(val.status_pkwt)
                });
