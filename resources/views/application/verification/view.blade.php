...
@section('title','Verifikasi Pembiayaan')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Detail Verifikasi Pembiayaan</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{route('application.verification.index')}}">Verifikasi Pembiayaan</a></li>
...
<script>
    ...
    function approveReject(status, description = ''){
        var token = "{{ csrf_token() }}";
        $.ajax({
            url: "{{ route('application.verification.approve-reject',$data->id) }}",
            method: 'POST',
            data: {
                '_token': token,
                'status': status,
