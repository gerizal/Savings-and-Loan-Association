...
@section('title','Data Verifikasi Pembiayaan')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Verifikasi Pembiayaan</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Verifikasi Pembiayaan</li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
                ...
                <table id="dataTable" class="table table-bordered table-striped table-hover" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th colspan="4"  class="text-center bg-primary">Verifikasi</th>
    ...
    <script>
        ...
        $(function () {
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('application.verification.datatable') !!}",
                    type: 'GET'
                },
                columns: [
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('application.verification.datatable') !!}?"+params.toString()).load();
        }
    </script>
@endpush
