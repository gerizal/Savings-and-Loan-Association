...
@section('title','Data Pengajuan Slik')
@section('breadcrumb')
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Data Pengajuan Slik</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                ...
                <table id="dataTable" class="table table-bordered table-striped table-hover" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th colspan="4"  class="text-center bg-success">Slik</th>
    ...
    <script>
        ...
        $(function () {
            var employeeDT = $('#dataTable').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: "{!! route('application.slik.datatable') !!}",
                    type: 'GET'
                },
                columns: [
        ...
        function reloadDataTable(){
            ...
            $('#dataTable').DataTable().ajax.url("{!! route('application.slik.datatable') !!}?"+params.toString()).load();
        }
    </script>
@endpush
